...
def main():
    ...
    st.subheader("List of Trees to be Harvested")
    ...
    st.dataframe(lowtrees_sorted.style.format({"X Coordinate": "{:.1f}", "Y Coordinate": "{:.1f}", "DBH": "{:.1f}", "Growth Rate": "{:.1f}"}), height=423, width=800, hide_index=True)
